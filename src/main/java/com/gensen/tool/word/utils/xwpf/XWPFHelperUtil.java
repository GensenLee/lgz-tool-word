...
import com.gensen.tool.word.poitools.ParagraphStyle;
import com.gensen.tool.word.poitools.TextStyle;
 ...
 */
public class XWPFHelperUtil {
    private static Logger logger = Logger.getLogger(XWPFHelperUtil.class.toString());
